...
document.getElementById("history_province");
document.getElementById("history_city");
document.getElementById("history_area");
...
function getProvince() {
    const historyProvinceTag = document.getElementById("history_province");
    const provinceTag = document.getElementById("province");
    for (let i = 0; i < provinceList.length; i++) {　　　　
        const province = provinceList[i];　　　　　　　　　　
        const provinceName = province.name;　　　　　　　　
        provinceArray[i] = provinceName;　　　　　　　　　　　
        provinceTag.add(new Option(provinceName, i.toString()));
        historyProvinceTag.add(new Option(provinceName, i.toString()));　　　　
    }
}

function chooseProvince(th) {
    const historyCityTag = document.getElementById("history_city");
    const cityTag = document.getElementById("city");
    const index = th.selectedIndex - 1;　　　　　　　　　　
    const provinceName = provinceArray[index];　　　　
    for (let n = 0; n < provinceList.length; n++) {　　　　
        const province = provinceList[n];　　　　　　　　　　　
        if (province.name === provinceName) {　　　　　　
            cityList = province.cityList;　　　　　　　　　　　　
            cityTag.innerHTML = "";
            historyCityTag.innerHTML = "";　　　　　　　　　　　　　　　
            for (let c = 0; c < cityList.length; c++) {　　　　　　
                const city = cityList[c];　　　　　　　　　　　　　　　
                const cityName = city.name;　　　　　　　　　　　　
                cityArray[c] = cityName;　　　　　　　　　　　　　
                cityTag.add(new Option(cityName, c.toString()));
                historyCityTag.add(new Option(cityName, c.toString()));　　　　　　
            }
        }
    }
}
...
function chooseCity(ci) {
    const historyAreaTag = document.getElementById("history_area");
    const areaTag = document.getElementById("area");
    const index = ci.selectedIndex;
    ...
    for (let j = 0; j < cityList.length; j++) {
        ...
        if (city.name === cityName) {
            ...
            areaTag.innerHTML = "";
            historyAreaTag.innerText = "";
            for (let k = 0; k < areaList.length; k++) {
                const area = areaList[k];
                areaTag.add(new Option(area, k.toString()));
                historyAreaTag.add(new Option(area, k.toString()));
            }
        }
    }
}
